...
# Kept in step with MSIME-Linux and MSIME-Engine.
...
#
# .mm is included: the Objective-C++ bridge is where this frontend's own logic
# lives, so leaving it out would exempt most of the repository.
git ls-files --cached --others --exclude-standard \
    'shared/*.cpp' 'shared/*.h' 'shared/*.mm' \
    'platforms/*.cpp' 'platforms/*.h' 'platforms/*.mm' \
    | sort -u \
